...
export class Note {
  ...
  @Prop({
    type: [{ usuario_id: String, username: String, nombre: String, rol: String, invitacion: String }],
    default: [],
  })
  colaboradores: { usuario_id: string; username: string; nombre: string; rol: string; invitacion: string }[];
